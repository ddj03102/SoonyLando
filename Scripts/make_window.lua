...
local but_name = {'무기', '방어구', '악세사리', '소모품', '재료'}
local choice_menu = {
[but_name[1]]	= {95, 124, 90},
[but_name[2]]	= {91, 92},
[but_name[3]]	= {93, 150},
[but_name[4]]	= {},
[but_name[5]]	= {103, 104, 105, 106, 107, 108, 109, 110, 111}
}
local Delicate = {
...
function make_Window()
			...
			for j, b in pairs(choice_menu[but_name[i]]) do
				...
				happy_but[j].onClick.Add(function()
					...
					for l, n in pairs(Delicate[B]) do
						...
						D_count[l].text = (Delicate_count[B][l] ~= nil and Delicate_count[B][l]) or '<color=#FE2E2E>잘못됨</color>'
	...
	Client.GetTopic('Love3').Add(function(Table, Table2, txt)
		...
		for i, v in pairs(T) do
			...
			oq[11][i].text = v..' / '..Delicate_count[txt][i]
		end
